...
|--------------|--------------|--------------|  
| **Modelo predictivo para la tasa de cancelación de clientes** | **Modelo de predicción de la cantidad de pedidos de taxi** | **Modelo predictivo del valor de mercado de un auto** |  
